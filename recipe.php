		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="recipeName" class="col-sm-4 control-label">Recipe Name :</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="recipeName" name="recipeName" placeholder="Recipe Name" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="customerName" class="col-sm-4 control-label">Customers Using the Recipe :</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="customerName" name="customerName" placeholder="Contact Number" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:60%;">Product Detail / Explanation</th>
			...
			<table class="table" id="manageOrderTable">
				<thead>
					<tr>
						<th>#</th>
						<th>Recipe Name</th>
						<th>Customers Using the Recipe</th>
						<th>Product Name</th>
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT recipe_item.recipe_item_id, recipe_item.recipe_id, recipe_item.products_id, recipe_item.products_detail FROM recipe_item WHERE recipe_item.recipe_id = {$orderId}";
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						<option value="">~~SELECT~~</option>
			  						<?php
			  							$productSql = "SELECT * FROM products"; // AND quantity != 0
			  							$productData = $connect->query($productSql);
