		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" placeholder="Örn: 11/07/2017" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Müşteri Bilgisi</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Örn: Öztürk Endüstriyel Plastik Kalip Metal San ve Tic" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">İletişim Bilgisi</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Örn: (0212) 485 24 21" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label" placeholder="Örn: 220">İndirim</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst">TOPKDV</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Yükleniyor..."> <i class="glyphicon glyphicon-plus-sign"></i> Ürün Ekle </button>
			      ...
			      <button type="submit" id="createOrderBtn" data-loading-text="Yükleniyor..." class="btn btn-success"><i class="glyphicon glyphicon-ok"></i> Değişiklikleri Kaydet</button>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Yükleniyor..." class="btn btn-success"><i class="glyphicon glyphicon-ok"></i> Değişiklikleri Kaydet</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer removeProductFooter">
        ...
        <button type="button" class="btn btn-primary" id="removeOrderBtn" data-loading-text="Yükleniyor..."> <i class="glyphicon glyphicon-ok"></i> Onayla</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
