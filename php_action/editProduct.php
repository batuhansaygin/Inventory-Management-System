...
if($_POST) {
	...
	$sql = "UPDATE tests SET companies_id = '$testsCustomer', tests_pg = '$testsPG', tests_date = '$testsDate', tests_formula = '$testsFormula', tests_mp = '$testsMP', tests_output = '$testsOutput', tests_result = '$testsResult', tests_by = '$testsBy' WHERE tests_id = '$productId'";
